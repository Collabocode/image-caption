...
gpt_system_prompt ="Please inspect the condition of the item to ensure it meets the required criteria for return or exchange. Verify if the item is in its original packaging, undamaged, and unused. Note any signs of wear, defects, or alterations. Based on the inspection, determine whether the item qualifies for a return, exchange, or warranty claim."
client = OpenAI(
    # base_url="https://api.fireworks.ai/inference/v1",
    base_url="https://api.fireworks.ai/inference/v1/",
    api_key="iOADKSeF8E4ImIuj5Yg2256DCDmaAJ5j5Uj5AUVZGn2Xr7qU"
    )
def debug_vllm_with_history(image_base64, text, vllm_info_model, assistant_prompt=None):
