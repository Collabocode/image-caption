...
references = ['references_images/adidas_space_purple.png', 'references_images/blue_hoodie.jpg', 'references_images/brown_hoodie.jpg', 'references_images/red_hoodie.jpg' , 'references_images/white_hoodie.jpg' ]
...
def run_llm_model_chain(vllm_response, trans_input_text, llm_info_model, meta_info):
    ...
    # msg+=vllm_response
    llm_input = f"Q:{trans_input_text}.\nRephrase and expand the question, and respond." + f"Here is the reference information: {meta_info}"
    ...
    logger.info(f'Check whether same or not:\n{check_stock_response}')
...
def run_model(img_path, input_text, vllm_info_model, llm_info_model):
    ...
    if vllm_info_model == 'accounts/fireworks/models/llama-v3p2-90b-vision-instruct':
        ...
        for data in references:
            ...
            ref_feat = run_CLIP_feature_extract(data)
        ...
        meta_info = {'product_name':"hoodie", 'color': "green", 'price': "50000", 'address':"Kelapa bangjek 100", 'size': "XXL", 'price':"50000"}
        ...
        highlight_prompt = "Please analyze the main object."
