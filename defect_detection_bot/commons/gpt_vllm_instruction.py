...
from .apparel import regular_products
...
f'Here is the list menu: {regular_products}.' +'Pay attention on the higlighted item if any.'
...
f'Here is the list menu: {regular_products}.'
