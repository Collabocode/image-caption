...
from base_prompt import system_prompt, user_prompt, system_prompt_v2, system_prompt_menu_v2, personalized_system_prompt
...
# save_name = 'hokben'
# imgs_dir="data/menu/sources/images/"
# save_dir ='data/menu/sources/'
# save_name = 'srchokben'
imgs_dir="data/currencies/references/images/"
save_dir ='data/currencies/references/'
save_name = 'refcurrencies_11b_v5'
list_data = []
...
for img_name in sorted(os.listdir(imgs_dir)):
    ...
    out_text = run_vllm(image_base64, personalized_system_prompt, user_prompt, vllm_model_id)
    logger.info(out_text)
    #--Step 2: Extract embedding
    out_emb = get_embedding(out_text, emb_model_id)
