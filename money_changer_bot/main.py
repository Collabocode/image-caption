import gradio as gr
from main_process import run_model
# from domain_specific import run_model
...
def main():
    with gr.Blocks(theme=my_theme, title='Money changer Bot') as demo:
        with gr.Row():
            with gr.Column():
        ...
        fn=run_model,
        inputs=[img_path, input_text, vllm_info_model, llm_info_model],
        ...
        # submit_btn.click(fn=run_model, inputs=[img_path, input_text, vllm_info_model, llm_info_model], 
        #                  outputs=[chatbot, text_in_en_version, text_out_en_version, token_used, price])
    demo.launch(server_name='100.123.191.144', server_port=7863)
