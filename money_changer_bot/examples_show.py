...
def read_json_output(path):
    ...
    for data in d:
        try:
            new_list.append([data['img_name'], data['caption'], data['summary']])
        except:
            new_list.append([data['img_name'], data['caption_analyze']])
...
def main():
    ...
    demo.launch(server_name='100.123.191.144',server_port=7777)
